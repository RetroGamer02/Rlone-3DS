...
#ifndef RLONE_OBJECT_ZOMBIE_H
#define RLONE_OBJECT_ZOMBIE_H

#include "object.h"

void	object_zombie_init(object_t *);
void	object_zombie_update(object_t *);
void	object_zombie_killed(object_t *);
