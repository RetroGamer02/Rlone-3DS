...
#ifndef RLONE_OBJECT_GOBLIN_H
#define RLONE_OBJECT_GOBLIN_H

#include "object.h"

void	object_goblin_init(object_t *);
void	object_goblin_update(object_t *);
void	object_goblin_killed(object_t *);
