...
#ifndef RLONE_OBJECT_STATUE_H
#define RLONE_OBJECT_STATUE_H

#include "object.h"

void	object_statue_init(object_t *);
void	object_statue_update(object_t *);
void	object_statue_killed(object_t *);
